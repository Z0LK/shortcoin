  ...
  return (
    <span className={cn('inline-flex items-center gap-1', className)}>
      ...
      <button
        ...
        className="grid size-5 place-items-center rounded-full text-ink-4 transition-colors hover:bg-raised hover:text-ink-2"
      >
      ...
      <a
        ...
        className="grid size-5 place-items-center rounded-full text-ink-4 transition-colors hover:bg-raised hover:text-info"
      >
...
export function UtilizationBar({ before, after }: { before: number; after?: number }) {
  ...
  const hot = a > 0.8
  return (
    <div className="relative h-2 w-full overflow-hidden rounded-[12px] bg-line">
