...
export const fr = {
  ...
  'trade.sell': 'Vendre',
  'trade.short': 'Short',
  'trade.amountBuy': 'Montant',
  'trade.amountSell': 'Quantité',
  'trade.holding': 'Détenu : {amount}',
  'trade.max': 'MAX',
  'trade.slippage': 'Tolérance de slippage',
  'trade.spot': 'Prix spot',
  'trade.execution': 'Prix d’exécution',
  'trade.impact': 'Impact sur le prix',
  'trade.fee': 'Frais',
  'trade.receive': 'Vous recevez',
  'trade.minReceived': 'Minimum reçu',
  'trade.impactHigh': 'Impact élevé : le pool est peu profond pour ce montant.',
  'trade.submitBuy': 'Acheter {symbol}',
  'trade.submitSell': 'Vendre {symbol}',
  'trade.nothingToSell': 'Vous ne détenez pas de {symbol}.',
  'trade.unavailable': 'Trading indisponible sur ce token.',
  'notify.bought': '{symbol} acheté',
  'notify.sold': '{symbol} vendu',
  'notify.fillBody': '{amount} {symbol} à {price} · {total}',
  'positions.portfolio': 'Portefeuille',
  'portfolio.holdings': 'Tokens détenus',
  'portfolio.empty': 'Aucun token en portefeuille.',
  'portfolio.emptyHint': 'Achetez un token depuis sa fiche.',
  'portfolio.trades': 'Historique des ordres',
  'portfolio.tradesEmpty': 'Aucun ordre pour le moment.',
  'portfolio.col.token': 'Token',
  'portfolio.col.amount': 'Quantité',
  'portfolio.col.avg': 'Prix moyen',
  'portfolio.col.spot': 'Spot',
  'portfolio.col.value': 'Valeur',
  'portfolio.col.pnl': 'PnL',
  'portfolio.col.time': 'Heure',
  'portfolio.col.side': 'Sens',
  'portfolio.col.price': 'Prix',
  'portfolio.col.total': 'Total',
  'errors.SlippageExceeded': 'Le prix a bougé au-delà de votre tolérance. Un nouveau devis est calculé.',
  'errors.InsufficientTokenBalance': 'Quantité supérieure à ce que vous détenez.',
